//Lista de tareas
//Regristrar el evento para el check,
//crear un arreglo que tenga las tareas incompletas
//
...
const checkComplete = document.getElementById('hide-completed');
...
function taskStatus(id, complete) {
  checkComplete.addEventListener('click',() =>{
    const checkIncomplete = tareas.filter((tarea) =>{
